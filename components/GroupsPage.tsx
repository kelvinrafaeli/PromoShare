...
import {
  ...
  Trash2, Edit3, Hash, CheckCircle2, Users, Loader2, AlertTriangle, X
} from 'lucide-react';
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-8 bg-white dark:bg-slate-900">
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`flex flex-col items-center gap-4 p-6 rounded-[2rem] border-2 transition-all group ${editingGroup?.platform === 'TELEGRAM' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/40 grayscale hover:grayscale-0'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-4 p-6 rounded-[2rem] border-2 transition-all group ${editingGroup?.platform === 'WHATSAPP' ? 'border-green-500 bg-green-50 dark:bg-green-900/30' : 'border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/40 grayscale hover:grayscale-0'
                      }`}
                  >
